...
class FaceModel:
    ...
    REYE_INDICES: np.ndarray = dataclasses.field(default_factory=lambda: np.array([36, 39], dtype=int))
    LEYE_INDICES: np.ndarray = dataclasses.field(default_factory=lambda: np.array([42, 45], dtype=int))
    MOUTH_INDICES: np.ndarray = dataclasses.field(default_factory=lambda: np.array([48, 54], dtype=int))
