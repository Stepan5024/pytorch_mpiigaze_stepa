...
config.gaze_estimator.checkpoint = '/media/stepan/Expansion/EyeGazeDataset/mpii/experiments/mpiigaze/lenet/exp00/00/checkpoint_0010.pth'
config.gaze_estimator.camera_params = '/home/stepan/Documents/pytorch_mpiigaze/data/calib/sample_params.yaml'
...
config.demo.camera_fov_deg = 40 # угол поля зрения камеры
